...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy meals as many people as possible.">
...
<div class="map-box">
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2017 TerraStorm Solutions. All rights reserved.
                </p>
            </div>
...
<!--JS-->
        ...
        <script src="https://cdn.jsdelivr.net/npm/respondjs@0.3.0/lib/respond.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/selectivizr@1.0.3/selectivizr.min.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtcH89spQXJC5D3Cwh7y7KPgz9-yj3ZP4"></script>
